...
async def help(ctx, *args):
    ...
    mainPanel = discord.Embed(color=EMBED_HELP_COLOR, title="Terraria Bot Help Documentation:")
 ...
 factor, flags can be ignored simply by putting none at the current command."
    ...
    flagsPanel = discord.Embed(color=EMBED_HELP_COLOR, title="Terraria Bot Help Documentation:")
    flagsDisplay = ""
